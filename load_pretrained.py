...
def load_pretrained_weights(yolo4dmodelfile='yolov5m-4d.pt', yolo5dtrainedmodelfile='yolov5m.pt', save_trained_pt='yolov5m-4d-trained.pt'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m','--model_file', help='Path to untrained yolo model', default='yolov5m-4d.pt', required=False)
    parser.add_argument('-p','--pretrained_model_file', help='Path to pretrained yolo model', default='yolov5m.pt', required=False)
    parser.add_argument('-s','--trained_save_file', help='Path to save the yolo model with trained weights', default='yolov5m-4d-trained.pt', required=False)
